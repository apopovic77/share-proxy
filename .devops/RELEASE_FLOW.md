...
6. Validate the site at `https://share.arkturian.com` (if applicable) and confirm fresh assets reached `/var/www/share.arkturian.com`.

## Rollback Strategy
- Use `.devops/rollback.sh` on the server to restore from `/var/backups/share-proxy-*`.
